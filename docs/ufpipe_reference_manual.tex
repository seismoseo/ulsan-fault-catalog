...
\code{detection\_test/reloc\_\{year\}\_uf[\_\{model\}]/results/} & dt.cc-relocated catalog + links (stage 6) \\
\bottomrule
\end{tabular}
\end{center}
...
\code{detection\_test/reloc\_2016\_uf/run\_picker\_reloc.py -{}-skip-build}, which drives the external
